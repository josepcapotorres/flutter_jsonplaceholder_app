...
class UserAlbumsView extends StatefulWidget {
  static const routeName = "user_albums_view";

  @override
  _UserAlbumsViewState createState() => _UserAlbumsViewState();
}

class _UserAlbumsViewState extends State<UserAlbumsView> {
